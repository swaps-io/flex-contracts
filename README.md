...
Flex protocol provides [components](#component) that implement _core functionally_. From these basic building blocks,
many flows can be constructed depending on current needs of the parties. There is a separate
[Flex Flow SDK](https://github.com/swaps-io/flex-flow-sdk) that provides a higher level functionality to encode the most
common flows in secure and tested way. If no flow there satisfies requirements - a custom flow can be encoded using core
[Flex SDK](https://github.com/swaps-io/flex-sdk).
